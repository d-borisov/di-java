...
class GuiceInjectApplicationTestcontainersTest {
    ...
    void setUp() {
        ...
        injector = Guice.createInjector(Modules.override(new GuiceInjectApplication.GuiceModule()).with(new TestModule()));
    }
